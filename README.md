...
Steps to Use:
1. Click <a href="https://github.com/Adock90/FastCheck/releases/tag/FastCheckImproved">Releases</a> and <a href="https://github.com/Adock90/FastCheck/releases/download/FastCheckImproved/FastCheck.sh">download</a>
2. Verify with <code>sha256sum FastCheck.sh</code>
   Output in sha256sums.txt

3. Call with <code>sudo FastCheck.sh</code>
4. Enjoy
